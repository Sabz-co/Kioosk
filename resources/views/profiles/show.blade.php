            ...
            <div>
                <div class="text-center mb-4 pb-2">
                    <div class="flex flex-col items-center justify-center p-3 rounded-xl bg-silver-200">
                        ...
                        @if ($user->id != auth()->id() )
                        <a href="#" class="my-2 mx-auto w-full sm:w-5/6 rounded-lg bg-brown-500 border border-transparent hover:text-brown-500 hover:border-brown-500 hover:bg-silver-100 text-white py-1 px-2 lg:px-6 subscribe-user" data-source-id="{{ $user->id }}">{{ $user->isSubscribedTo ? 'دنبال شده' : 'دنبال کردن' }}</a>
