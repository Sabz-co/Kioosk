    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between"  v-bind:class="view.navbarHeightClass">
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          <!-- Mobile menu button-->
          <button id="mobile-icon" class="inline-flex items-center justify-center p-2 rounded-md bg-white p-1 rounded-full text-gray-700 hover:text-gray-900 focus:outline-none" aria-expanded="false">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <button class="bg-gray-menu p-1 rounded-full text-white hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
          ...
          <a href="{{ route('book.create') }}" class="bg-gray-menu flex items-center p-1 mr-3 rounded-full text-white hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" >
