<nav class="bg-white w-full top-0 main-header h-menu"  > {{-- :class="{ 'scrolled': !view.atTopOfPage } --}} 
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between"  v-bind:class="view.navbarHeightClass">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <button class="bg-white p-1 rounded-full text-gray-700 hover:text-gray-900 focus:outline-none">
          ...
          <a href="{{ route('book.create') }}" class="bg-white p-1 rounded-full text-gray-700 hover:text-gray-900 focus:outline-none" >
