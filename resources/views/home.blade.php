        ...
        <div class="w-full sm:w-2/3 lg:w-3/4 p-2">
            ...
            <div class="flex bg-gray-200 flex-col md:flex-row rounded-lg text-sm md:text-base">
                ...
                <div class="flex flex-col flex-1 text-center p-4 m-2 items-center justify-between">
                    ...
                    <div class="flex flex-col justify-between w-full items-center my-4">
                        <p class="text-gray-700 mr-auto">۸۰۳ صفحه</p>
                    ...
                    <div class="flex flex-col sm:flex-row items-center sm:items-start">
                        ...
                        <div class="flex flex-col mr-2 mr-0 sm:mr-2 w-full">
                            <div class="flex flex-wrap justify-between">
                                ...
                                <h6 class="text-gray-600">سه دقیقه پیش</h6>
                            </div>
            ...
            <div class="flex flex-wrap">
                <div class=" text-center p-3 w-1/2 lg:w-1/3 xl:w-1/4">
                    <img src="{{ asset('images/avatar.jpg') }}" class="w-20 h-20 rounded-full mx-auto -mb-8  border-4  border-gray-200" alt="">
                    <div class="bg-gray-200 rounded-xl p-2 pt-8">
            ...
            <div>
                ...
                <div class="sticky top-0 bg-white">
                    <div class="border-b flex mb-1 pb-2">
                        <div class="text-gray-600 flex items-baseline">
